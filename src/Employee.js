...
export class Employee extends Component{
    ...
    refreshList(){
        fetch(variables.API_URL+'employee').then(response=>response.json()).then(data=>{
            this.setState({employees:data});
        })
        fetch(variables.API_URL+'department').then(response=>response.json()).then(data=>{
                ...
                {employees.map(emp => 
                    <tr key={emp.EmployeeId}>
                        ...
                        <td>
                            ...
                            data-bs-toggle='modal' data-bs-target='#exampleModal' onClick={()=>this.editClick(emp)}>
            ...
            <div className='modal fade' id='exampleModal' tabIndex='-1' aria-hidden='true'>
                <div className='modal-dialog modal-lg modal-dialog-centered'>
                    <div className='modal-content'>
                        ...
                        <div className='p-2 w-50 bd-highlight'>
                            <img width='250px' height='250px' src={PhotoPath + PhotoFileName} alt='employee img' />
